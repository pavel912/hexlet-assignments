...
public class ArticlesServlet extends HttpServlet {
    ...
    private void showArticles(HttpServletRequest request,
        ...
        // BEGIN
        PagedList<Article> articles = new QArticle().orderBy().id.asc().setFirstRow(offset).setMaxRows(articlesPerPage).findPagedList();
        request.setAttribute("articles", articles.getList());
        request.setAttribute("totalPageCount", articles.getTotalPageCount());
        // END
    ...
    private void newArticle(HttpServletRequest request,
        ...
        // BEGIN
        List<Category> categories = new QCategory().orderBy().id.asc().findList();
